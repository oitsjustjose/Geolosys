...
- FIXED: **_Actually_** fix crash when holding the Pro Pick if a dimension's sea level wasn't set
...
- CHANGED: The way prospecting works again; looks for the first _Sample_ in the chunk
...
- FIX: log outputs with the Mineral tracking process; this was causing _lots_ of lag.
...
- FIXED: Dimension blacklist configs not working if you allow an ore in dim -1 or 1 (**_AGAIN_**)
