...
public class OreRemover {
    ...
    // public static List<Supplier<PlacedFeature>>
    // filterFeatures(List<Supplier<PlacedFeature>> features) {
    // List<Supplier<PlacedFeature>> removed = new
    // LinkedList<Supplier<PlacedFeature>>();
    ...
    // .map(t -> Boolean.valueOf(featureRemover(t.state.getBlock(), confFeat).size()
    // > 0))
