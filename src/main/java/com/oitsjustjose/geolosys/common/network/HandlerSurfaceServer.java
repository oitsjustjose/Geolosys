 ...
 * 15/01/2015
 */
public class HandlerSurfaceServer implements IMessageHandler<PacketSurface, IMessage>
{
    public IMessage onMessage(final PacketSurface message, MessageContext ctx)
    {
