 ...
 * 15/01/2015
 */
public class HandlerUndergroundServer implements IMessageHandler<PacketUnderground, IMessage>
{
    public IMessage onMessage(final PacketUnderground message, MessageContext ctx)
    {
