...
// LivingEntity harvester = (LivingEntity)
// context.get(LootParameters.THIS_ENTITY);
...
// if (y <= 12) {
// stackToAdd = new
// ItemStack(ItemInit.getInstance().getModItems().get("geolosys:anthracite_coal"));
// } else if (y <= 24) {
// stackToAdd = new
// ItemStack(ItemInit.getInstance().getModItems().get("geolosys:bituminous_coal"));
// } else if (y <= 36) {
// stackToAdd = new
// ItemStack(ItemInit.getInstance().getModItems().get("geolosys:lignite_coal"));
// } else if (y <= 48) {
// stackToAdd = new
// ItemStack(ItemInit.getInstance().getModItems().get("geolosys:peat_coal"));
// }
...
// GlobalLootModifierSerializer<CoalVariants> {
// @Override
// public CoalVariants read(ResourceLocation name, JsonObject object,
