...
public class ModConfig
{
        ...
        private static void init()
        {
                ...
                // "What Surface Prospecting Results display; SAMPLES means it's based off of samples in the chunk - OREBLOCKS means it's based
                // on the actual ores in the ground")
