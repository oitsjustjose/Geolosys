...
public class ModConfig
{
    ...
    private static void init()
    {
        ...
        ENABLE_SMELTING = COMMON_BUILDER.comment("Enable Smelting Clusters -> Ingots").define("enableClusterSmelting", true);
        ...
        RETRO_REPLACE = COMMON_BUILDER.comment("Retroactively replace vanilla / Tagged ores to their Geolosys Counterpart when entering a chunk").define("retroReplace", true);
        DISABLE_VANILLA_ORE_GEN = COMMON_BUILDER.comment("Disable generation of Vanilla ores").define("disableVanillaOreGen", true);
        ENABLE_FORTUNE_ON_ALL_ORES = COMMON_BUILDER.comment("Allow fortune to work on ores that drop clusters too").define("enableFortuneOnAllOres", false);
        COMMON_BUILDER.pop();
        ...
        BORING_SAMPLES = COMMON_BUILDER.comment("Disable drops from samples, only popping up text of the item instead").define("boringSamples", false);
        ...
        PRO_PICK_SURFACE_MODE = COMMON_BUILDER.comment("What Surface Prospecting Results display; SAMPLES means it's based off of samples in the chunk - OREBLOCKS means it's based on the actual ores in the ground").defineEnum("surfaceProspectingResults", SURFACE_PROSPECTING_TYPE.OREBLOCKS);
        COMMON_BUILDER.pop();
