...
public class ModConfig
{
    ...
    private static void init()
    {
        ...
        ENABLE_SMELTING = COMMON_BUILDER.comment("Enable Smelting Clusters -> Ingots").define("enableClusterSmelting",
                true);
        ...
        ENABLE_FORTUNE_ON_ALL_ORES = COMMON_BUILDER.comment("Allow fortune to work on ores that drop clusters too")
        ...
        BORING_SAMPLES = COMMON_BUILDER.comment("Disable drops from samples, only popping up text of the item instead")
