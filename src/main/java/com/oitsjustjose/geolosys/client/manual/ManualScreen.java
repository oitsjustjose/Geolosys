...
//         chapters.get("stones")
//                 .addPage(new BookPageItemDisplay("geolosys.guide.chapter.stones.name",
//                         "geolosys.guide.chapter.stones.text", new ItemStack[] { new ItemStack(Blocks.DIORITE),
//                                 new ItemStack(Blocks.ANDESITE), new ItemStack(Blocks.GRANITE) }));
//         count++;
//         if (count == 12) {
//             resources.add(new BookPageContents("geolosys.guide.chapter.resources.name"));
//             page_num += 1;
...
//     @Override
//     public void render(MatrixStack mxStack, int mouseX, int mouseY, float partialTicks) {
//         this.renderBackground(mxStack);
...
//         this.blit(mxStack, left, top, 0, 0, WIDTH, HEIGHT);
...
//             List<IReorderingProcessor> parts = this.fontRenderer
//                     .trimStringToWidth(ITextProperties.func_240652_a_(header), (int) ((WIDTH - (18 * 2)) / textScale));

//             // Draw the text above the book if it's multi-line :|
//             if (parts.size() > 1) {
//                 int topToDraw = top - (12 * parts.size());
//                 for (IReorderingProcessor p : parts) {
//                     int width = this.fontRenderer.getStringWidth(p.toString());
//                     this.fontRenderer.func_238422_b_(mxStack, p, left + (WIDTH - width) / 2.0F, topToDraw, 7829367);
//                     topToDraw += 12;
//                 }
//             } else {
//                 int headerWidth = this.fontRenderer.getStringWidth(header);
//                 this.fontRenderer.drawString(mxStack, header, left + (WIDTH - headerWidth) / 2.0F, top + 12, 0);
//             }

//             if (currentPage instanceof BookPageItemDisplay) {
//                 renderItemDisplayPage(mxStack, (BookPageItemDisplay) currentPage, mouseX, mouseY);
//             } else if (currentPage instanceof BookPageText) {
//                 renderTextPage(mxStack, (BookPageText) currentPage);
//             } else if (currentPage instanceof BookPageOre) {
//                 renderOrePage(mxStack, (BookPageOre) currentPage, mouseX, mouseY);
//             } else if (currentPage instanceof BookPageURL) {
//                 renderURLPage(mxStack, (BookPageURL) currentPage, mouseX, mouseY, partialTicks);
//             }
...
//     private void renderItemDisplayPage(MatrixStack mxStack, BookPageItemDisplay page, int mouseX, int mouseY) {
...
//         List<IReorderingProcessor> parts = this.fontRenderer.trimStringToWidth(
//                 ITextProperties.func_240652_a_(I18n.format(page.getDescription())),
//                 (int) ((WIDTH - (18 * 2)) / textScale));
        

//         // this.fontRenderer.drawSplitString(mxStack,
//         // I18n.format(page.getDescription()), (int) ((left + 18) / textScale),
