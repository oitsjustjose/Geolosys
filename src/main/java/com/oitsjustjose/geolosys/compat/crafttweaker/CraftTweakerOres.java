...
public class CraftTweakerOres {
     ...
     * @param chance       The relative chance of this deposit's occurance in the
     *                     world
     * @param density      The density of the pluton; 1.0 represents nothing but
     *                     ore, 0.0 represents nothing but original contents.
     * @param dimBlacklist A blacklist of dimension IDs which the deposit may not
     *                     appear in
     */
    @ZenMethod
     ...
     * @param yMax               The maximum Y level this deposit should be found
     * @param size               The approximate size of this deposit
     * @param chance             The relative chance of this deposit's occurance in
     *                           the world
     * @param density            The density of the pluton; 1.0 represents nothing
     *                           but ore, 0.0 represents nothing but original
     *                           contents.
     * @param dimBlacklist       A blacklist of dimension IDs which the deposit may
     *                           not appear in
     * @param blockStateMatchers An array of Blockstates which the deposit can
     ...
     * @param dimBlacklist A blacklist of dimension IDs which the deposit may not
     *                     appear in
     * @param biomes       A list of strings which represent the Biome registry
     *                     names (from /ct biomes) OR BiomeDictionary names (e.g.
     *                     DRY, ARID, etc.)
     * @param isWhitelist  A boolean value describing whether or not the biomes list
     *                     is a whitelist or not.
     */
    @ZenMethod
    public static void addOre(crafttweaker.api.block.IBlockState oreBlock,
            crafttweaker.api.block.IBlockState sampleBlock, int yMin, int yMax, int size, int chance, float density,
     ...
     * @param blockStateMatchers An array of Blockstates which the deposit can
     *                           replace during generation
     * @param biomes             A list of strings which represent the Biome
     *                           registry names (from /ct biomes)
     * @param isWhitelist        A boolean value describing whether or not the
     *                           biomes list is a whitelist or not.
     */
    @ZenMethod
    public static void addOre(crafttweaker.api.block.IBlockState oreBlock,
            crafttweaker.api.block.IBlockState sampleBlock, int yMin, int yMax, int size, int chance, float density,
     ...
     *                           gnenerate
     * @param sampleBlocks       The blockstates of the samples to be placed to
     *                           represent the oreBlocks
     * @param sampleBlockChances The list of percentages that each sampleBlock has
     *                           to gnenerate
     * @param yMin               The minimum Y level this deposit should be found
     * @param yMax               The maximum Y level this deposit should be found
     * @param size               The approximate size of this deposit
