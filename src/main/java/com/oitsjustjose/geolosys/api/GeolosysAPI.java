...
public class GeolosysAPI
{
         ...
         */
        public static void registerMineralDeposit(BlockState oreBlock, BlockState sampleBlock, int yMin, int yMax,
                        int size, int chance, String[] dimBlacklist, List<BlockState> blockStateMatchers, float density)
        {
        ...
        public static void registerMineralDeposit(HashMap<BlockState, Integer> oreBlockMap,
                        HashMap<BlockState, Integer> sampleBlockMap, int yMin, int yMax, int size, int chance,
                        String[] dimBlacklist, List<BlockState> blockStateMatchers, float density)
        {
         ...
         */
        public static void registerMineralDeposit(BlockState oreBlock, BlockState sampleBlock, int yMin, int yMax,
                        int size, int chance, String[] dimBlacklist, List<BlockState> blockStateMatchers,
                        List<Biome> biomeList, List<BiomeDictionary.Type> biomeTypes, boolean isWhitelist,
                        float density)
        {
                DepositBiomeRestricted tempDeposit = new DepositBiomeRestricted(oreBlock, sampleBlock, yMin, yMax, size,
                                chance, dimBlacklist, blockStateMatchers, biomeList, biomeTypes, isWhitelist, density);
                plutonRegistry.addOrePluton(tempDeposit);
        }
        ...
        public static void registerMineralDeposit(HashMap<BlockState, Integer> oreBlockMap,
                        HashMap<BlockState, Integer> sampleBlockMap, int yMin, int yMax, int size, int chance,
                        String[] dimBlacklist, List<BlockState> blockStateMatchers, List<Biome> biomeList,
                        List<BiomeDictionary.Type> biomeTypes, boolean isWhitelist, float density)
        {
                DepositMultiOreBiomeRestricted tempDeposit = new DepositMultiOreBiomeRestricted(oreBlockMap,
                                sampleBlockMap, yMin, yMax, size, chance, dimBlacklist, blockStateMatchers, biomeList,
