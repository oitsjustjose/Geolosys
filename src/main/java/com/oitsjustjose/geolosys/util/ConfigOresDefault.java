...
public class ConfigOresDefault
{
    ...
    public static final int cinnabarChanceDefault = 5;
    public static final int[] cinnabarDimBlacklistDefault = new int[]{-1, 1};
    ...
    public static final int goldChanceDefault = 3;
    public static final int[] goldDimBlacklistDefault = new int[]{-1, 1};
    ...
    public static final int lapisChanceDefault = 4;
    public static final int[] lapisDimBlacklistDefault = new int[]{-1, 1};
    ...
    public static final int[] quartzDimBlacklistDefault = new int[]{-1, 1};
    ...
    public static final int kimberliteChanceDefault = 4;
    public static final int[] kimberliteDimBlacklistDefault = new int[]{-1, 1};
    ...
    public static final int[] berylDimBlacklistDefault = new int[]{-1, 1};
    ...
    public static final int hematiteChanceDefault = 8;
    public static final int[] hematiteDimBlacklistDefault = new int[]{-1, 1};
    ...
    public static final int limoniteChanceDefault = 6;
    ...
    public static final int azuriteChanceDefault = 7;
    ...
    public static final int tealliteChanceDefault = 7;
    ...
    public static final int galenaChanceDefault = 6;
    public static final int[] galenaDimBlacklistDefault = new int[]{-1, 1};
    ...
    public static final int bauxiteChanceDefault = 6;
    ...
    public static final int[] autuniteDimBlacklistDefault = new int[]{-1, 1};
    ...
    public static final int sphaleriteChanceDefault = 5;
