...
@Config(modid = Lib.MODID)
public class ModConfig
{
    @Config.Comment("Geolosys Configuration")
    ...
    public static class Conf
    {
        ...
        public FeatureControl featureControl = new FeatureControl();
        ...
        public UserEntries userEntries = new UserEntries();
        ...
        public void onChanged(ConfigChangedEvent.OnConfigChangedEvent event)
        {
            if (event.getModID().equalsIgnoreCase(Lib.MODID))
            {
                ...
                ConfigManager.sync(Lib.MODID, Config.Type.INSTANCE);
            }
        }
    }
}